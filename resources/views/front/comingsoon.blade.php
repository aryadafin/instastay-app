...
@section('content')
  <section id="content" class="max-w-[640px] w-full min-h-screen mx-auto flex flex-col bg-[#F8F8F8] overflow-x-hidden pb-[122px] relative">
    <header class="flex justify-center h-[376px] px-[18px] relative overflow-hidden -mb-[106px]">
      <img src="{{asset('assets/images/backgrounds/BG.png')}}" class="absolute object-cover w-full h-full" alt="backgrounds">
    ...
    <div id="Promo" class="mt-6 w-full bg-white overflow-hidden py-6 flex flex-col gap-3">
      ...
      <div class="main-carousel">
        <a href="" class="pl-[18px] last:pr-[18px]">
          <div class="w-fit flex flex-col gap-4">
            <div class="w-[310px] h-[160px] flex shrink-0 overflow-hidden rounded-xl">
              <img src="{{asset('assets/images/thumbnails/thumbnail1.png')}}" class="object-cover w-full h-full" alt="thumbnail">
            </div>
        ...
        <a href="" class="pl-[18px] last:pr-[18px]">
          <div class="w-fit flex flex-col gap-4">
            <div class="w-[310px] h-[160px] flex shrink-0 overflow-hidden rounded-xl">
              <img src="{{asset('assets/images/thumbnails/thumbnail2.png')}}" class="object-cover w-full h-full" alt="thumbnail">
            </div>
            <div class="flex flex-col gap-1">
        ...
        <a href="" class="pl-[18px] last:pr-[18px]">
          <div class="w-fit flex flex-col gap-4">
            <div class="w-[310px] h-[160px] flex shrink-0 overflow-hidden rounded-xl">
              <img src="{{asset('assets/images/thumbnails/thumbnail3.png')}}" class="object-cover w-full h-full" alt="thumbnail">
            </div>
            <div class="flex flex-col gap-1">
